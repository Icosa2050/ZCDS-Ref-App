...
define view entity ZR_SALESORDERSCHEDULELINETP_2
  as select from ZR_SalesOrderScheduleLine
  association [1..1] to ZR_SalesOrderTP_2            as _SalesOrder
    on $projection.SalesOrder = _SalesOrder.SalesOrder
  association        to parent ZR_SalesOrderItemTP_2 as _SalesOrderItem
